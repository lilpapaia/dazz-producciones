    ...
    return (
      <div className="min-h-screen bg-zinc-950 flex items-center justify-center">
        <div className="text-center">
          <p className="text-zinc-400 mb-2">No hay datos para el periodo seleccionado</p>
          <button onClick={() => { setQuarter(''); setGeoFilter(''); setCompanyId(null); }}
            className="text-amber-500 hover:text-amber-400 text-sm">Resetear filtros</button>
        </div>
      </div>
    );
  }
