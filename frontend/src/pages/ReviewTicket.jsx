    ...
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 pt-6 pb-8 relative">
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-sm p-6 space-y-6">
          ...
          <div className={`hidden md:block rounded-sm p-4 ${ticket.notes ? 'bg-amber-500/10 border border-amber-500/30' : 'bg-blue-500/10 border border-blue-500/30'}`}>
            <div className="flex items-start gap-3">
              <div className={`mt-0.5 ${ticket.notes ? 'text-amber-400' : 'text-blue-400'}`}>
                {ticket.notes ? (
              ...
              <div>
                <p className={`text-sm font-semibold ${ticket.notes ? 'text-amber-400' : 'text-blue-400'}`}>
                  {ticket.notes ? 'Warnings en extracción IA' : 'Datos extraídos por IA'}
                </p>
