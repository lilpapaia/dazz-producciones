  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-between mb-4 flex-wrap gap-2">
        <h1 className="font-['Bebas_Neue'] text-xl tracking-wider text-zinc-100">Notifications</h1>
      ...
      <div className="flex gap-2 mb-3.5 items-center">
        <button onClick={() => setFilter('all')} className={`text-[11px] px-3 py-1 rounded-full border transition-all ${filter === 'all' ? 'bg-amber-500 text-zinc-950 border-amber-500 font-semibold' : 'border-zinc-700 text-zinc-400'}`}>All</button>
      ...
      <div className="bg-zinc-900 border border-zinc-800 rounded-md overflow-hidden">
        ...
        <div className="flex items-center justify-between px-3.5 py-2 bg-zinc-800 text-[11px] text-zinc-400 border-b border-white/[.04]">
          <span><b className="text-amber-400">{unreadCount} unread</b> of {notifications.length} recent notifications</span>
          <span className="text-zinc-600">Archived after 30 days</span>
        </div>
